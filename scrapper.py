...
page = Client('https://www.air.irctc.co.in/onewaytrip?type=O&origin=MAA&originCity=Chennai&originCountry=IN&destination=BLR&destinationCity=Bengaluru&destinationCountry=IN&flight_depart_date=2020-03-25&ADT=1&CHD=0&INF=0&class=Economy&airlines=&ltc=0&searchtype=')
